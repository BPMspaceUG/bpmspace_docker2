...
var_tmp="<a href=\"http://server-"$var_server_name":"$var_http_proxyport_notlive"\" target=\"_blank\" rel=\"noopener\">http://server-"$var_server_name":"$var_http_proxyport_notlive"</a></p></br>"
